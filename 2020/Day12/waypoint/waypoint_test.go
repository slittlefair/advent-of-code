...
func TestWaypoint_MoveWaypoint(t *testing.T) {
	var baseShip = &ship.Ship{
		Co:        helpers.Coordinate{X: 99, Y: 13},
		FacingDir: "E",
	}
	type args struct {
		s   *ship.Ship
	...
	tests := []struct {
		...
		},
		{
			...
			want1: &ship.Ship{
				Co:        helpers.Coordinate{X: 99, Y: 105},
				FacingDir: "E",
			},
		},
		{
			...
			args: args{
				s: &ship.Ship{
					Co:        helpers.Coordinate{X: -6, Y: 22},
					FacingDir: "S",
				},
				d:   "F",
				val: 1,
			...
			want1: &ship.Ship{
				Co:        helpers.Coordinate{X: 64, Y: 22},
				FacingDir: "S",
			},
		},
		{
			...
			want1: &ship.Ship{
				Co:        helpers.Coordinate{X: 2, Y: -49},
				FacingDir: "E",
			},
		},
		{
			...
			args: args{
				s: &ship.Ship{
					Co:        helpers.Coordinate{X: 17, Y: 1333},
					FacingDir: "N",
				},
				d:   "F",
				val: 12,
			...
			want1: &ship.Ship{
				Co:        helpers.Coordinate{X: -127, Y: 1333},
				FacingDir: "N",
			},
		},
		{
			...
			args: args{
				s: &ship.Ship{
					Co:        helpers.Coordinate{X: 99, Y: 103},
					FacingDir: "S",
				},
				d:   "F",
				val: 5,
			...
			want1: &ship.Ship{
				Co:        helpers.Coordinate{X: 149, Y: 118},
				FacingDir: "S",
			},
		},
		{
			...
			want1: &ship.Ship{
				Co:        helpers.Coordinate{X: 5, Y: -27},
				FacingDir: "S",
			},
		},
		{
			...
			args: args{
				s: &ship.Ship{
					Co:        helpers.Coordinate{X: 1, Y: 12},
					FacingDir: "S",
				},
				d:   "F",
				val: 10,
			...
			want1: &ship.Ship{
				Co:        helpers.Coordinate{X: -59, Y: -318},
				FacingDir: "S",
			},
		},
		{
			...
			want1: &ship.Ship{
				Co:        helpers.Coordinate{X: 95, Y: 106},
				FacingDir: "E",
			},
		},
	}
